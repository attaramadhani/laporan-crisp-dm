...
> **Privacy Note**: The original dataset (`final_dataset_kspr_attala.csv`), sourced from the [Ministry of Health of the Republic of Indonesia](https://layanandata.kemkes.go.id/), is intentionally excluded from GitHub to protect health respondent privacy.
...
> **Catatan Privasi**: Dataset asli (`final_dataset_kspr_attala.csv`) yang bersumber dari [Kementerian Kesehatan RI](https://layanandata.kemkes.go.id/) sengaja tidak disertakan di GitHub untuk melindungi privasi responden kesehatan.
